export const Projects = [
    ...
    {
        name: 'verde',
        description: 'Python library for processing spatial data and interpolating it on regular grids',
    ...
    {
        name: 'arviz',
        description: 'Backend-agnostic tools for diagnostics and visualizations of Bayesian inference in Python',
    ...
    {
        name: 'SquidPy',
        description: 'Collection of tools for the analysis and visualization of spatial molecular data',
    ...
    {
        name: 'cf-xarray',
        description: 'An accessor for Xarray objects that interprets  Climate and Forecast (CF) metadata convention attributes',
        domains: ['🌎 Geoscience'],
    ...
    {
        name: 'omfit',
        description: 'Integrated modeling and experimental data analysis software for magnetically confined thermonuclear fusion experiments',
    ...
    {
        name: 'xmip',
        description: 'Analysis ready CMIP6 data in Python the easy way with pangeo tools.',
        domains: ['🌎 Geoscience'],
